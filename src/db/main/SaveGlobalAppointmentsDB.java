...
public class SaveGlobalAppointmentsDB 
{
	/**
	 ...
	 */
	public static int saveApps(AppointmentList list)
	{
		...
		try
		{
			...
			if(list.getSize()!=0)
			{
				...
				String[] msg = {"jsonlist="+jsonlist.toString()};
				
				//send the list to the server
				response = DBInteraction.communicate(msg, DBInteraction.connect(ActionURLs.UPLOAD_GLOBAL_URL));
