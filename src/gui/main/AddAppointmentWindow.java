...
public class AddAppointmentWindow
{
	 ...
	 */
	public AddAppointmentWindow(MainWindow window, User user)
	{
		//this.user = user;
		...
		if(res == 1)
		{
			...
			int msg = list.addAppointment(new Appointment(descArea.getText(), (String)placeField.getText(), y, m, d, h, min, user.getName()), list.getRoot());
