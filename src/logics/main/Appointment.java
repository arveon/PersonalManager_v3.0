...
public class Appointment 
{
	 ...
	 */ 
	public Appointment(String description, String place, String year, String month, String day, String hour, String minute, String author)
	{
		next = null;
	...
	public void printDetails()
	{
		...
		System.out.println("Authod: " + author);
		System.out.println();
	}
	...
	/**
	 * Method used to get the author of the appointment
	 * @return author of the appointment
	 */
	...
	/**
	 * Method used to get the date of the appointment in the displayable format
	 * @return date in dd/mm/YYYY format
	 */
	public String getDateString()
	{
		return Integer.toString(date).substring(6, 8) + "/" + Integer.toString(date).substring(4,6) + "/" + Integer.toString(date).substring(0, 4);
	}
	
	/**
	 * Method used to get the time of the appointment in the displayable format
